...
//double *getYlmi(double *x, double *y, double *z, double *oOri, const double *cf, int icount, int lMax);
//double *getIntegrand(double *Flir, double *Ylmi, int rsize, int icount, int lMax);
//void getC(double *Cs, const double *ws, double *rw2, double *gns, double *summed, double rCut, int lMax, int rsize, int gnsize, int nCenters, int nNeighbours, double eta, double *weights);
