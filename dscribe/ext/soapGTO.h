...
inline int getDeltas(double *x, double *y, double *z, double *positions,
                     double r[3], const vector<int> &indices);
inline void getRsZs(double *x, double *x2, double *x4, double *x6, double *x8,
                    ...
                    double *y16, double *y18, double *z, double *r2, double *r4,
                    double *r6, double *r8, double *r10, double *r12,
                    double *r14, double *r16, double *r18, double *z2,
                    double *z4, double *z6, double *z8, double *z10,
                    double *z12, double *z14, double *z16, double *z18,
                    int size, int lMax);
void getAlphaBeta(double *aOa, double *bOa, double *alphas, double *betas,
                  int Ns, int lMax, double oOeta, double oOeta3O2);
void getCfactors(double *preCoef, int Asize, double *x, double *x2, double *x4,
                 ...
                 double *r8, double *r10, double *r12, double *r14, double *r16,
                 double *r18, int totalAN, int lMax);
void getC(double *CDevX, double *CDevY, double *CDevZ, double *C,
          double *preCoef, double *x, double *y, double *z, double *r2,
          double *bOa, double *aOa, double *exes, int totalAN, int Asize,
          int Ns, int Ntypes, int lMax, int posI, int typeJ,
          vector<int> &indices);
...
void soapGTO(py::array_t<double> derivatives, py::array_t<double> descriptor,
             ...
             const double cutoffPadding, const int Ns, const int lMax,
